...
public class LatchSingleton {
    ...
    private static class LatchSingletonHolder{
        ...
        private static final CountDownLatch terminateLatch = new CountDownLatch(NUMBER_OF_LEIA_THREADS);
    ...
    public static CountDownLatch getTerminateLatch(){
        return LatchSingletonHolder.terminateLatch;
    }
}
