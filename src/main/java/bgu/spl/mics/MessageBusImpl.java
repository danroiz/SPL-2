...
import java.util.concurrent.LinkedBlockingQueue;
    ...
    public class MessageBusImpl implements MessageBus {
       // private final Object FUTURE_MAP_LOCK;
        ...
        public <T> void complete(Event<T> e, T result) {
            ...
            else System.out.println("Oops HashMap Doesn't work good. Thread: " + Thread.currentThread().getName() + " tried to complete event: " + e);
        }
        ...
        private <T> Future<T> addEventToMicroService (MicroService nextToReceiveEvent, Event<T> e) {
            ...
            if ((nextToReceiveEvent != null) && (microServiceToMsgQueueMap.get(nextToReceiveEvent) != null)) { // ad
                future = new Future<>();
                //System.out.println("Thread :" + Thread.currentThread().getName() + " is going to put future in may. event: " + e);
